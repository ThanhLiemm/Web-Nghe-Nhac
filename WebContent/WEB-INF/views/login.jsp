                        ...
                        <div class="login-form">
                            <form action="login.htm" method="post">
                                <div class="form-group">
                                    ...
                                    <input name= "mail"type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter E-mail" value="${mail}">
								...
								<a name="btnRegister" href="register.htm" class="btn oneMusic-btn mt-30">Đăng Ký</a>
                            </form>
                            <div>${message}</div>
