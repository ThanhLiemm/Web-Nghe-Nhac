            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-8">
                    <div class="login-content">
                        <h3>Welcome To OneMusic</h3>
                        <!-- Login Form -->
                        <div class="login-form">
                            <form action="register.htm" method="post">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Email address</label>
                                    <input type="email" name ="mail" value = "${mail}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter E-mail">
                                ...
                                <div class="form-group">
                                    <label for="exampleRPassword1">RePassword</label>
                                    <input type="password" name = "repassword" value = "${repassword}" class="form-control" id="exampleRPassword1" placeholder="RePassword">
                                </div>
                                <button type="submit" class="btn oneMusic-btn mt-30">Đăng Kí</button>
                            </form>
                            <div>${message}</div>
                        </div>
                    </div>
