								...
								<ul>
									...
									<li><a href="#">Thể Loại<i></i></a>
										<ul class="dropdown">
											...
											<li><a href="theloai.htm?Loai=Khac">Các Thể Loại
													Khác</a></li>
		...
		<div class="hero-slides owl-carousel">
			...
			<div
				...
				<div class="slide-img bg-img"
					style="background-image: url(img/bg-img/bg-1.jpg);"></div>
				<!-- Slide Content -->
				<div class="container">
					<div class="row">
						<div class="col-12">
							<div class="hero-slides-content text-center">
								<h6 data-animation="fadeInUp" data-delay="100ms">Album mới
									nhất</h6>
						...
						<div class="col-12">
							<div class="hero-slides-content text-center">
								<h6 data-animation="fadeInUp" data-delay="100ms">Album mới
									nhất</h6>
								<h2 data-animation="fadeInUp" data-delay="300ms">
									Colorlib Music <span>Colorlib Music</span>
								</h2>
								<a data-animation="fadeInUp" data-delay="500ms" href="#"
									class="btn oneMusic-btn mt-50">Discover <i
									class="fa fa-angle-double-right"></i></a>
			...
			<div class="row justify-content-center">
				<div class="col-12 col-lg-9">
					<div class="ablums-text text-center mb-70">
						<p>One Music luôn cập nhật, mang đến cho bạn những album mới
							nhất.</p>
					</div>
				</div>
			</div>
					...
					<div class="albums-slideshow owl-carousel">
						<c:forEach var="album" items="${album}">
							...
							<div class="single-album">
								<a href="Album.htm?Id=${album.id}"><img
									src="${album.imagecore}"></a>
								<div class="album-info">
									<a href="Album.htm?Id=${album.id}">
										<h5>${album.ten}</h5>
									</a>
									<p>${album.ngayph}</p>
								</div>
	...
	<section
		...
		<div class="container-fluid">
			...
			<div class="row">
				...
				<c:forEach var="baihat" items="${list}">
					<!-- Single Album Area -->

					<div class="col-12 col-sm-6 col-md-4 col-lg-2">
						<div class="single-album-area wow fadeInUp" data-wow-delay="100ms">
							<div class="album-thumb">
								<a href="Nhac.htm?Id=${baihat.id}"><img
									src="${baihat.imagecore}" alt="" width="256" height="256"></a>

							</div>
						</div>
						<div class="album-info">

							<a href="Nhac.htm?Id=${baihat.id}" name="Id" value="${baihat.id}""><h5>${baihat.ten}</h5></a>
							<p>${baihat.nhacsi}</p>
				...
				<div class="col-12 col-md-6">
					...
					<p class="copywrite-text">
						<a href="#"> <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
							...
							href="https://www.facebook.com/liemlemlinh.nguyen"
							target="_blank">Thanh Liêm</a> <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
					</p>
				</div>
